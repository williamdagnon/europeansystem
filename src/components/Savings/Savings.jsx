  ...
  return (
    <div className="subgrid-two-item grid-common grid-c6">
        <div className="grid-c-title">
            <h3 className="grid-c-title-text">Économies</h3>
                        ...
                        <div className="grid-item" key = { saving.id }>
                            <div className="grid-item-top">
                                ...
                                <div className="grid-item-top-r">
                                    <span className="text-silver-v1">{ saving.saving_amount } EUR</span>
                                </div>
                            </div>
                            <div className="grid-item-bottom">
                                <div className="grid-item-badges">
                                    <span className="grid-item-badge">Date de prise { saving.date_taken }</span>
                                    <span className="grid-item-badge"> Montant restant  { saving.amount_left } EUR</span>
                                </div>
